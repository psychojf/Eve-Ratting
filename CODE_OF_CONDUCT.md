...
the **Eve Ratting** community a harassment-free experience for everyone,
...
* Focusing on what is best not just for us as individuals, but for the
  overall community
* Keeping discussion on-topic: EVE Online PvE tooling, log parsing, the
  dashboard UI, and the codebase
...
* Sharing in-game credentials, account details, or asking others to do so
* Promoting use of the project for activities that violate the EVE Online
  EULA or Terms of Service (e.g. botting, client modification, packet
  inspection)
